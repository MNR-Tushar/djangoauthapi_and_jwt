...
ROOT_URLCONF = 'djangoauthapi_and_jwt.urls'
...
WSGI_APPLICATION = 'djangoauthapi_and_jwt.wsgi.application'
...
SIMPLE_JWT = {
    "ACCESS_TOKEN_LIFETIME": timedelta(minutes=int(os.environ.get('ACCESS_TOKEN_LIFETIME_MINUTES', 20))),
